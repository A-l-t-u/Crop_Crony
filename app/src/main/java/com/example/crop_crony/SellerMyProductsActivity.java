...
public class SellerMyProductsActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.seller_my_products_activity);
        ...
        CropCronyDatabase DB = new CropCronyDatabase(SellerMyProductsActivity.this);

        D = (DrawerLayout) findViewById(R.id.sellerMyProductsDrawer);
        ...
        RecyclerView RV = (RecyclerView) findViewById(R.id.sellerMyProductsRecyclerView);

        Button B = (Button) findViewById(R.id.sellerMyProductsButton);

        LinearLayoutManager LLM = new LinearLayoutManager(SellerMyProductsActivity.this);
        RV.setLayoutManager(LLM);
        ArrayList<ProductsClass> ProductData = new ArrayList<ProductsClass>();
        ProductData.clear();
        Cursor productsData = DB.GetDataById("ProductsTable", "ProductSeller", UserName);
        if (productsData.getCount() == 0)
        {
            Toast.makeText(SellerMyProductsActivity.this, "No data found!", Toast.LENGTH_SHORT).show();
        }
        else
        {
        ...
        SellerMainAdapter productData = new SellerMainAdapter(SellerMyProductsActivity.this, ProductData);
