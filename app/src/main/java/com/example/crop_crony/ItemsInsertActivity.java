...
public class ItemsInsertActivity extends AppCompatActivity
{
    DrawerLayout D;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.items_insert_activity);
        ...
        CropCronyDatabase dataBase = new CropCronyDatabase(ItemsInsertActivity.this);
        ...
        EditText ET = (EditText) findViewById(R.id.itemsInsertEditText1);
        Button Btn = (Button) findViewById(R.id.itemsInsertButton);
        ...
        Btn.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                if(Result)
                {
                    Toast.makeText(ItemsInsertActivity.this, "Insert Successfully!", Toast.LENGTH_SHORT).show();
                }
                else
                {
                    Toast.makeText(ItemsInsertActivity.this, "Insertion Failed!", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
