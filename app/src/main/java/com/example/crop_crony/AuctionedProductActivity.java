...
public class AuctionedProductActivity extends AppCompatActivity
{
    DrawerLayout D;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.auctioned_product_activity);
        ...
        CropCronyDatabase DB = new CropCronyDatabase(AuctionedProductActivity.this);
        ...
        LinearLayoutManager LLM = new LinearLayoutManager(AuctionedProductActivity.this);
        ...
        {
            Toast.makeText(AuctionedProductActivity.this, "Data not found!", Toast.LENGTH_SHORT).show();
        }
        else
        {
        ...
        BuyerMainAdapter productData = new BuyerMainAdapter(AuctionedProductActivity.this, ProductData);
