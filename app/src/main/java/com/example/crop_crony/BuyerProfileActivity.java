...
public class BuyerProfileActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.buyer_profile_activity);

        getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);
        getWindow().getDecorView().setSystemUiVisibility(View.SYSTEM_UI_FLAG_HIDE_NAVIGATION);

        CropCronyDatabase dataBase = new CropCronyDatabase(BuyerProfileActivity.this);
        ...
        B.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                else
                {
                    ...
                    if (Result)
                    {
                        Toast.makeText(BuyerProfileActivity.this, "Updated.", Toast.LENGTH_SHORT).show();
                        ET.setEnabled(false);
                    ...
                    {
                        Toast.makeText(BuyerProfileActivity.this, "Update Failed, Please try again.", Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
